...
func buildQuerystring(filter map[string][]string, fields map[string][]string, page string, sort []string) string {
	b := strings.Builder{}
	ra := false
